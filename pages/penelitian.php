    ...
    <div class="container">
        <div class="row">
            <div class="container px-4">
                <h3 class="fw-bold" style="color: #294c60;">DAFTAR PENELITIAN</h3>
            </div>
            <div class="container tb_berita px-4">
                <table id="tb_matkul" class="table table-hover table-responsive-sm" style="width: 100%">
                    <thead style="background-color: #294c60; color: white;">
                        <tr class="align-middle">
                            <th>No</th>
                            <th>Judul</th>
                            <th>Nama Dosen Peneliti</th>
                            <th>Dipublikasikan Pada</th>
                            <th>Dipublikasikan Tahun</th>
                            <th>Tingkat</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                $i = 0;
                while($Openelitian = mysqli_fetch_assoc($penelitian)) : $i++?>
                        <tr>
                            <td><?= $i ?></td>
