    ...
    <div class="container mt-4">
        <div class="container">
            <dl class="row ">
                ...
                <h3 class="fw-bold mb-2 text-warning"><?= $agenda['judul'] ?></h3>
                <hr width="100%">

                <dt class="col-sm-3 mt-4">Tujuan</dt>
                <dd class="col-sm-9 mt-4"><?= $agenda['tujuan'] ?></dd>

                <dt class="col-sm-3 mt-4">Tempat</dt>
                <dd class="col-sm-9 mt-4"><?= $agenda['tempat'] ?></dd>

                <dt class="col-sm-3 mt-4">Tanggal</dt>
                <dd class="col-sm-9 mt-4"><?= $agenda['tglAgenda'] ?></dd>

                <dt class="col-sm-3 mt-4">Waktu</dt>
                <dd class="col-sm-9 mt-4"><?= $agenda['waktu'] ?> WIB</dd>

            </dl>

            <div class="bg-warning p-0 mt-5">
                <h4 class="text-white fw-bold text-center p-2">JANGAN LUPA YA</h4>
            </div>
        </div>
    </div>
