...
$pengumuman = mysqli_query($koneksi, 'SELECT * FROM tbl_pengumuman ORDER BY tanggal');
                    ...
                    <ul class="navbar-nav ms-lg-auto me-lg-4 mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu ddi" aria-labelledby="navbarDarkDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="./index.php">Pengumuman</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mt-3">
                        ...
                        <?php 
                        $banyakDataperHalaman = 5;
                        $banyakData = mysqli_num_rows(mysqli_query($koneksi, 'SELECT * FROM tbl_pengumuman'));
                        ...
                        if(isset($_POST['cari'])){
                            ...
                            $pengumuman = mysqli_query($koneksi, "SELECT * FROM tbl_pengumuman WHERE 
                            judul LIKE '%$katakunci%'
                            ORDER BY id DESC LIMIT $DataAwal, $banyakDataperHalaman");
                        }
                        else {
                            $pengumuman = mysqli_query($koneksi, "SELECT * FROM tbl_pengumuman ORDER BY id DESC LIMIT $DataAwal, $banyakDataperHalaman");
                        }

                        while($Opengumuman = mysqli_fetch_array($pengumuman)): ?>
                        <ul class="list-group list-group-flush placeholder-glow">
                            <a href="../pengumuman.php?id=<?= $Opengumuman['id'] ?>"
