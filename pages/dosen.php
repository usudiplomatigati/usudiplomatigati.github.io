    ...
    <div class="container">
        <div class="row">
            <div class="container px-4">
                <h3 class="fw-bold text-dark">DAFTAR DOSEN TETAP</h3>
            </div>
            <div class="container tb_berita px-4">
                <table id="tb_dosen" class="table table-hover table-responsive-sm mt-2" style="width: 100%">
                    ...
                    <tbody>
                        <?php 
                $i = 0;
                while($Odosen = mysqli_fetch_assoc($dosen)) :$i++
                 ?>
                        <tr>
                            <td><?= $i ?></td>
                            <td><?= $Odosen['nama'] ?></td>
