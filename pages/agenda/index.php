...
$agenda = mysqli_query($koneksi, 'SELECT * FROM tbl_agenda ORDER BY id DESC');
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mt-4">
                        ...
                        $banyakData = mysqli_num_rows(mysqli_query($koneksi, 'SELECT * FROM tbl_agenda'));
                        ...
                        if(isset($_POST['cari'])){
                            ...
                            $agenda = mysqli_query($koneksi, "SELECT * FROM tbl_agenda WHERE 
                            judul LIKE '%$katakunci%'
                            ORDER BY id DESC LIMIT $DataAwal, $banyakDataperHalaman");
                        }
                        else {
                            $agenda = mysqli_query($koneksi, "SELECT * FROM tbl_agenda ORDER BY id DESC LIMIT $DataAwal, $banyakDataperHalaman");
                        }

                        while($Oagenda = mysqli_fetch_array($agenda)): ?>
                        <ul class="list-group list-group-flush">
                            <a href="../agenda.php?id=<?= $Oagenda['id'] ?>"
