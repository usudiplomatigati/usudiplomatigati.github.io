    ...
    <div class="container">
        <div class="row">
            <div class="container px-4">
                <div class="mt-4">
                    <h3 class="fw-bold">PERATURAN AKADEMIK</h3>
                    <hr width="100%" class="mb-4">
                    <img src="../imageUpload/peraturan_akademik.jpg" class="w-50 mx-auto d-block">
                    <a href="../fileUpload/Peraturan Akademik USU.pdf" download>
                        <h6 class="fw-light my-4 text-center">Klik untuk dapat mendownload File Peraturan Akademik
                            disini!</h6>
                    </a>
                </div>
            </div>
