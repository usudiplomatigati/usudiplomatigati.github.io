...
if (isset($_POST['upload'])){
	...
	if($gambar != ""){
		...
		if(in_array($extension, $extension_accepted)){
			...
			$query = "INSERT INTO tbl_berita(gambar,judul,isi,sorotan,tanggal) VALUES (
			'$new_name','$judul','$isi', '$sorotan', '$tanggal')";
			...
			echo "<script>alert('Ekstensi tidak diperbolehkan');window.location='./add-data.php';</script>";
		}

	}
    else{
		$query = "INSERT INTO tbl_berita(judul,isi,sorotan,tanggal) VALUES (
		'$judul','$isi', '$sorotan', '$tanggal')";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-3">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 fw-bolder text-success">TAMBAH BERITA</h2>
                </div>
            </nav>
                ...
                <div class="col-lg-12">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control summernote" id="exampleFormControlTextarea1" name="sorotan"
                                placeholder=""></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Isi Berita</label>
                            <textarea class="form-control summernote1" id="exampleFormControlTextarea1" name="isi"
                                placeholder=""></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            <button class="btn btn-success float-end px-3 py-2" type="submit" name="upload"><i
