...
if(!isset($_GET['id'])){
 ...
 $id = $_GET['id'];
 $query = mysqli_query($koneksi, "SELECT * FROM tbl_matkul WHERE id = $id");
 $Ematkul = mysqli_fetch_array($query);
 ...
 if(isset($_POST['edit'])) {
	...
	$query = "UPDATE tbl_matkul SET kode='$kode', matkul='$matkul', sks='$sks', semester='$semester' WHERE id = $id";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-3">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 fw-bolder text-primary">DAFTAR MATA KULIAH</h2>
                </div>
            </nav>

            <div class="container-fluid p-lg-3">
                <button class="btn btn-primary center my-2 py-2 px-3" data-bs-toggle="modal"
                    data-bs-target="#TambahMatkulModal">Tambah Mata Kuliah <i
                        class="bi bi-plus-circle ms-2"></i></button>

                <!-- TAMBAH MATAKULIAh MODAL -->
                <div class="modal fade" id="TambahMatkulModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="1">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header bg-primary">
                                <h5 class="modal-title text-white fw-bold" id="exampleModalLabel">FORM TAMBAH MATA
                                    KULIAH</h5>
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1"
                                            class="form-label fw-semibold text-primary">Kode</label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            name="kode" placeholder="Kode Mata Kuliah" />
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1"
                                            class="form-label fw-semibold text-primary">Mata Kuliah</label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            name="matkul" placeholder="Nama Mata Kuliah" />
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1"
                                            class="form-label fw-semibold text-primary">Jumlah SKS</label>
                                        <input type="number" class="form-control" id="exampleFormControlInput1"
                                            name="sks" placeholder="Jumlah Satuan Kredit Semester" />
                                    </div>

                                    <div class="mb-4">
                                        <label for="exampleFormControlInput1"
                                            class="form-label fw-semibold text-primary">Semester</label>
                                        <input type="number" class="form-control" id="exampleFormControlInput1"
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-primary px-3 py-2 fw-bold" type="submit" name="tambah">TAMBAH
                                        <i class="bi bi-plus-square ms-2"></i></button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 g-3 my-3 tb_berita">
                    <table id="tb_matkul" class="table table-hover table-responsive-sm" style="width: 100%">
                        ...
                        <tbody>
                            <?php while($Omatkul = mysqli_fetch_assoc($matkul)) : ?>
                            <tr>
                                <td><?= $Omatkul['kode'] ?></td>
                                <td><?= $Omatkul['matkul'] ?></td>
                                <td><?= $Omatkul['sks'] ?></td>
                                <td><?= $Omatkul['semester'] ?></td>
                                <td class="align-middle">
                                    <a href="./edit-data.php?id=<?= $Omatkul['id'] ?>"><i
                                            class="bi bi-pencil-fill text-white me-1 bg-primary p-2"></i></a>

                                    <!-- EDIT MATAKULIAH MODAL -->
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleFormControlInput1" name="kode"
                                                                placeholder="Kode Mata Kuliah"
                                                                value="<?= $Ematkul['kode'] ?>" required />
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="exampleFormControlInput1"
                                                                class="form-label fw-semibold text-primary">Mata
                                                                Kuliah</label>
                                                            <input type="text" class="form-control"
                                                                id="exampleFormControlInput1" name="matkul"
                                                                placeholder="Nama Mata Kuliah"
                                                                value="<?= $Ematkul['matkul'] ?>" required />
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="exampleFormControlInput1"
                                                                class="form-label fw-semibold text-primary">Jumlah
                                                                SKS</label>
                                                            <input type="number" class="form-control"
                                                                id="exampleFormControlInput1" name="sks"
                                                                placeholder="Jumlah Satuan Kredit Semester"
                                                                value="<?= $Ematkul['sks'] ?>" required />
                                                        </div>
                                                        ...
                                                        <div class="mb-4">
                                                            <label for="exampleFormControlInput1"
                                                                class="form-label fw-semibold text-primary">Semester</label>
                                                            <input type="number" class="form-control"
                                                                id="exampleFormControlInput1" name="semester"
                                                                placeholder="Semester"
                                                                value="<?= $Ematkul['semester'] ?>" required />
                                                        </div>

                                                    </div>
                                                    <div class="modal-footer">
                                                        <button class="btn btn-primary px-3 py-2 fw-bold" type="submit"
                                                            name="edit">EDIT
                                                            <i class="bi bi-pencil-fill ms-2"></i></button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
