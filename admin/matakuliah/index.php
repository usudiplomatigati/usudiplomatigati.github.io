...
if (isset($_POST['tambah'])){
	...
	$query = "INSERT INTO tbl_matkul(kode,matkul,sks,semester) VALUES (
        '$kode','$matkul', '$sks', '$semester')";
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <a data-bs-toggle="modal" data-bs-target="#HapusData" href=""
                                        ...
                                        <i class="bi bi-trash-fill text-white bg-primary p-2"></i>
                                    </a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="./delete-data.php?id=<?= $Omatkul['id'] ?>"><button
