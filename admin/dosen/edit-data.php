...
if(!isset($_GET['id'])){
 ...
 $id = $_GET['id'];
 $query = mysqli_query($koneksi, "SELECT * FROM tbl_dosen WHERE id = $id");
 $Edosen = mysqli_fetch_array($query);
 
 if(isset($_POST['edit'])) {
    $nama = $_POST['Enama'];
    $jabatan = $_POST['Ejabatan'];
    $nidn = $_POST['Enidn'];
    $nip = $_POST['Enip'];
    $golongan = $_POST['Egolongan'];
    

    $query = "UPDATE tbl_dosen SET nama='$nama', jabatan='$jabatan', nidn='$nidn', nip='$nip', golongan='$golongan' WHERE id = $id
    ";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-3">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 fw-bolder text-dark">DAFTAR DOSEN</h2>
                </div>
            </nav>

            <div class="container-fluid p-lg-3">
                <button class="btn btn-dark justify-content-center align-items-center my-2 py-2 px-3"
                    data-bs-toggle="modal" data-bs-target="#DosenModal">Tambah Dosen <i
                        class="bi bi-plus-circle ms-2"></i></button>

                <!-- TAMBAH DOSEN MODAL -->
                <div class="modal fade" id="DosenModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="1">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header bg-dark">
                                <h5 class="modal-title text-white fw-bold" id="exampleModalLabel">FORM TAMBAH DOSEN</h5>
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1"
                                            class="form-label fw-semibold text-dark">Nama
                                            Dosen</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1"
                                            class="form-label fw-semibold text-dark">Jabatan Fungisional</label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            placeholder="Jabatan Fungisional" name="jabatan" required />
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1"
                                            class="form-label fw-semibold text-dark">NIDN</label>
                                        <input type="number" class="form-control" id="exampleFormControlInput1"
                                            placeholder="Nomor Induk Nasional Dosen" name="nidn" required />
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1"
                                            class="form-label fw-semibold text-dark">NIP</label>
                                        <input type="number" class="form-control" id="exampleFormControlInput1"
                                            placeholder="Nomor Identitas Pegawai Negeri Sipil" name="nip" required />
                                    </div>

                                    <div class="mb-4">
                                        <label for="exampleFormControlInput1"
                                            class="form-label fw-semibold text-dark">Golongan</label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            placeholder="Golongan" name="golongan" required />
                                    </div>

                                </div>
                                <div class="modal-footer">
                                    <button class="btn btn-dark px-3 py-2 fw-bold" type="submit" name="tambah"> TAMBAH<i
                ...
                <div class="col-12 col-sm-12 col-md-12 g-3 my-3 tb_berita">
                    <table id="tb_dosen" class="table table-hover table-responsive-sm" style="width: 100%">
                        ...
                        <tbody>
                            <?php while($Odosen = mysqli_fetch_assoc($dosen)) : ?>
                            <tr>
                                <td><?= $Odosen['nama'] ?></td>
                                <td><?= $Odosen['jabatan'] ?></td>
                                <td><?= $Odosen['nidn'] ?></td>
                                <td><?= $Odosen['nip'] ?></td>
                                <td><?= $Odosen['golongan'] ?></td>
                                <td class="align-middle">
                                    <a href="./edit-data.php?id=<?= $Odosen['id'] ?>"><i
                                            class="bi bi-pencil-fill text-white me-1 bg-dark p-2"></i></a>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleFormControlInput1" placeholder="Nama Dosen"
                                                                name="Enama" value="<?= $Edosen['nama'] ?>" required />
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="exampleFormControlInput1"
                                                                class="form-label fw-semibold text-dark">Jabatan
                                                                Fungisional</label>
                                                            <input type="text" class="form-control"
                                                                id="exampleFormControlInput1"
                                                                placeholder="Jabatan Fungisional" name="Ejabatan"
                                                                value="<?= $Edosen['jabatan'] ?>" required />
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                id="exampleFormControlInput1"
                                                                placeholder="Nomor Induk Nasional Dosen" name="Enidn"
                                                                value="<?= $Edosen['nidn'] ?>" required />
                                                        </div>
                                                        ...
                                                        <div class=" mb-3">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                ...
                                                                name="Enip" value="<?= $Edosen['nip'] ?>" required />
                                                        </div>
                                                        ...
                                                        <div class="mb-4">
                                                            <label for="exampleFormControlInput1"
                                                                class="form-label fw-semibold text-dark">Golongan</label>
                                                            <input type="text" class="form-control"
                                                                id="exampleFormControlInput1" placeholder="Golongan"
                                                                name="Egolongan" value="<?= $Edosen['golongan'] ?>"
                                                                required />
                                                        </div>

                                                    </div>
                                                    <div class="modal-footer">
                                                        <button class="btn btn-dark px-3 py-2 fw-bold" type="submit"
                                                            name="edit">EDIT <i
                                                                class="bi bi-pencil-fill ms-2"></i></button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                    <a href=""><i class="bi bi-trash-fill text-white bg-dark p-2"></i></a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>
