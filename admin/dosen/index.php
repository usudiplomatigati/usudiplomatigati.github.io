...
if (isset($_POST['tambah'])){
	...
	$query = "INSERT INTO tbl_dosen(nama,jabatan,nidn,nip,golongan) VALUES (
        '$nama','$jabatan', '$nidn', '$nip', '$golongan')";
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <a data-bs-toggle="modal" data-bs-target="#HapusData" href=""
                                        ...
                                        <i class="bi bi-trash-fill text-white bg-dark p-2"></i>
                                    </a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="./delete-data.php?id=<?= $Odosen['id'] ?>"><button
