        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-3">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 fw-bolder text-warning">DAFTAR AGENDA</h2>
                </div>
            </nav>
            ...
            <div class="container-fluid p-lg-3">
                <div class="col-12 col-sm-12 col-md-12 g-3 my-3 tb_berita">
                    <table id="tb_berita" class="table table-hover table-responsive-sm" style="width: 100%">
                        ...
                        <tbody>
                            <?php while($Oagenda = mysqli_fetch_assoc($agenda)) : ?>
                            <tr>
                                <td><?= $Oagenda['judul'] ?></td>
                                <td><?= $Oagenda['tempat'] ?></td>
                                <td><?= $Oagenda['tglAgenda'] ?></td>
                                <td><?= $Oagenda['tanggal'] ?></td>
                                <td><a href="./edit-data.php?id=<?= $Oagenda['id'] ?>"><i
                                            class="bi bi-pencil-fill text-white me-1 bg-warning p-2"></i></a>
                                    <a data-bs-toggle="modal" data-bs-target="#HapusData" href="">
                                        <i class="bi bi-trash-fill text-white bg-warning p-2"></i>
                                    </a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="./delete-data.php?id=<?= $Oagenda['id'] ?>"><button
