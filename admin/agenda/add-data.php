...
if (isset($_POST['upload'])){
    ...
    $query = "INSERT INTO tbl_agenda(judul,tujuan,tempat,tglAgenda,waktu,tanggal) VALUES (
    '$judul','$tujuan', '$tempat', '$tglAgenda', '$waktu', '$tanggal')";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-3">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 fw-bolder text-warning">TAMBAH AGENDA</h2>
                </div>
            </nav>
            ...
            <div class="container-fluid p-lg-3">
                <div class="col-lg-12">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Judul Agenda</label>
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="judul"
                                placeholder="Judul Agenda" required />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="tempat"
                                placeholder="Tempat Diselenggarakan" required />
                        </div>

                        <div class="mb-4">
                            <label for="exampleFormControlInput1" class="form-label">Tanggal</label>
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="tglAgenda"
                                placeholder="Tanggal Diselenggarakan" required>
                        </div>

                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Waktu</label>
                            <input type="time" class="form-control" id="exampleFormControlInput1" name="waktu" required>
                        </div>
                        ...
                        <div class="mb-3">
                            <button class="btn btn-warning text-white float-end px-3 py-2" type="submit"
                                name="upload"><i class="bi bi-plus-square me-2"></i>
                                Upload</button>
                        </div>
                    </form>
                </div>
