...
$agenda = mysqli_fetch_array($query);
...
if (isset($_POST['edit'])){
    ...
    $query = "UPDATE tbl_agenda SET judul='$judul', tujuan='$tujuan', tempat='$tempat', tglAgenda='$tglAgenda', waktu='$waktu', tanggal='$tanggal' WHERE id = '$id'";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-3">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 fw-bolder text-warning">EDIT AGENDA</h2>
                </div>
            </nav>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="judul"
                                value="<?= $agenda['judul'] ?>" placeholder="Judul Agenda" required />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control summernote" id="exampleFormControlTextarea1"
                                name="tujuan"><?= $agenda['tujuan'] ?></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="tempat"
                                value="<?= $agenda['tempat'] ?>" placeholder="Tempat Diselenggarakan" required />
                        </div>

                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Tanggal</label>
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="tglAgenda"
                                value="<?= $agenda['tglAgenda'] ?>" placeholder="Tanggal Diselenggarakan" required />
                        </div>

                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Waktu</label>
                            <input type="time" class="form-control" id="exampleFormControlInput1" name="waktu"
                                value="<?= $agenda['waktu'] ?>" required />
                        </div>
                        ...
                        <div class="mb-3">
                            <button class="btn btn-warning float-end px-3 py-2 text-white" type="submit" name="edit"><i
