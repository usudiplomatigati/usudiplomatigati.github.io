...
if (isset($_POST['upload'])){
    ...
    $query = "INSERT INTO tbl_penelitian(judul,nama,di,tahun,tingkat) VALUES (
    '$judul','$nama', '$di', '$tahun','$tingkat')";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-3">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 fw-bolder" style="color: #294c60;">TAMBAH PENELITIAN
                    </h2>
                </div>
            </nav>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="di"
                                placeholder="Dipublikasikan pada" required />
                        </div>
                        ...
                        <div class="mb-3">
                            <button class="btn text-white float-end px-3 py-2" style="background-color: #294c60;"
                                type="submit" name="upload"><i class="bi bi-plus-square me-2"></i>
                                Upload</button>
                        </div>
                    </form>
                </div>
