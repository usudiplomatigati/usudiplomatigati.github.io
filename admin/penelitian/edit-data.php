...
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM tbl_penelitian WHERE id = $id");
$penelitian = mysqli_fetch_array($query);
...
if (isset($_POST['edit'])){
    ...
    $query = "UPDATE tbl_penelitian SET judul='$judul', nama='$nama', di='$di', tahun='$tahun', tingkat='$tingkat' WHERE id = '$id'";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-3">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 fw-bolder" style="color: #294c60;">EDIT PENELITIAN</h2>
                </div>
            </nav>
            ...
            <div class="container-fluid p-lg-3">
                <div class="col-lg-12">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Judul Peneltian</label>
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="judul"
                                value="<?= $penelitian['judul'] ?>" placeholder="Judul Penelitian" required />
                        </div>

                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Nama Peneliti</label>
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="nama"
                                value="<?= $penelitian['nama'] ?>" placeholder="Nama Dosen Peneliti" required />
                        </div>

                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Dipublikasi Pada</label>
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="di"
                                value="<?= $penelitian['di'] ?>" placeholder="Dipublikasikan pada" required />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="tahun"
                                value="<?= $penelitian['tahun'] ?>" placeholder="Dipublikasikan pada Tahun" required />
                        </div>

                        <div class="mb-4">
                            <select class=" form-select" aria-label="Default select example" name="tingkat">
                                <option value="Lokal /
                                    Nasional Tidak Terakreditasi" <?= ($penelitian['tingkat'] == 'Lokal /
                                    Nasional Tidak Terakreditasi') ? 'selected' : '' ?>>Lokal /
                                    Nasional Tidak Terakreditasi</option>
                                <option value="Nasional
                                    Terakreditasi" <?= ($penelitian['tingkat'] == 'Nasional
                                    Terakreditasi') ? 'selected' : '' ?>>Nasional
                                    Terakreditasi
                                </option>
                                <option value="Internasional"
                                    <?= ($penelitian['tingkat'] == 'Internasional') ? 'selected' : '' ?>>
                                    Internasional
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            <button class="btn float-end px-3 py-2 text-white" style="background-color: #294c60;"
                                type="submit" name="edit"><i class="bi bi-plus-square me-2"></i>
                                Edit</button>
                        </div>
                    </form>
                </div>
