...
if (isset($_POST['edit'])){
  ...
  $isi = $_POST['isi'];
	...
	if($gambar != ""){
		$extension_accepted = ['png','jpg','svg','pdf'];
		$x = explode('.', $gambar);
		...
		if(in_array($extension, $extension_accepted)){
			move_uploaded_file($file_tmp, '../image/pengumuman/' . $new_name);

			$query = "UPDATE tbl_pengumuman SET gambar='$new_name', judul='$judul', isi='$isi', tanggal='$tanggal' WHERE id = '$id'";
		...
		$query = "UPDATE tbl_pengumuman SET judul='$judul', isi='$isi', tanggal='$tanggal' WHERE id = '$id'";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-3">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 fw-bolder text-danger">EDIT PENGUMUMAN</h2>
                </div>
            </nav>
            ...
            <div class="container-fluid p-lg-3">
                <div class="col-lg-12">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class=" mb-3">
                            <label for="formFile" class="form-label">Gambar Pengumuman</label>
                            <input class="form-control" type="file" id="formFile" name="gambar"
                                value="<?= $pengumuman['gambar'] ?>" required />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleFormControlInput1" name="judul"
                                value="<?= $pengumuman['judul'] ?>" placeholder="Judul Pengumuman" required />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control summernote" id="exampleFormControlTextarea1"
                                name="isi"><?= $pengumuman['isi'] ?></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            <button class="btn btn-danger float-end px-3 py-2" type="submit" name="edit"><i
