...
<body>
    ...
    <nav class="navbar navbar-expand-lg" style="background-color: #ebecf1">
        <div class="container-fluid">
            <a class="navbar-brand fw-bolder text-success fs-2 ms-1" href="../../index.php">LOGO</a>
            <form class="d-flex">
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-3">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 fw-bolder text-danger">DAFTAR PENGUMUMAN</h2>
                </div>
            </nav>
            ...
            <div class="container-fluid p-lg-3">
                <div class="col-12 col-sm-12 col-md-12 g-3 my-3 tb_berita">
                    <table id="tb_berita" class="table table-hover table-responsive-sm" style="width: 100%">
                        ...
                        <tbody>
                            <?php while($Opengumuman = mysqli_fetch_assoc($pengumuman)) : ?>
                            <tr>
                                <td><?= $Opengumuman['judul'] ?></td>
                                <td><?= $Opengumuman['tanggal'] ?></td>
                                <td><a href="./edit-data.php?id=<?= $Opengumuman['id'] ?>"><i
                                            class="bi bi-pencil-fill text-white me-1 bg-danger p-2"></i></a>
                                    <a data-bs-toggle="modal" data-bs-target="#HapusData" href="">
                                        <i class="bi bi-trash-fill text-white bg-danger p-2"></i>
                                    </a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="./delete-data.php?id=<?= $Opengumuman['id'] ?>"><button
