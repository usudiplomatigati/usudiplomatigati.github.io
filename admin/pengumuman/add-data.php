  ...
  $isi = $_POST['isi'];
	...
	if($gambar != ""){
		...
		if(in_array($extension, $extension_accepted)){
			...
			$query = "INSERT INTO tbl_pengumuman(gambar,judul,isi,tanggal) VALUES (
			'$new_name','$judul','$isi','$tanggal')";
		...
		$query = "INSERT INTO tbl_pengumuman(judul,isi,tanggal) VALUES (
		'$judul','$isi', '$tanggal')";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-3">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 fw-bolder text-danger">TAMBAH PENGUMUMAN</h2>
                </div>
            </nav>
            ...
            <div class="container-fluid p-lg-3">
                <div class="col-lg-12">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <button class="btn btn-danger float-end px-3 py-2" type="submit" name="upload"><i
